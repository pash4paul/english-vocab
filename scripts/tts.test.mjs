...
const synth = {
  ...
  pending: false,
  paused: false,
  getVoices: () => [{ name: 'Melina', lang: 'en-US', localService: true }],
...
eq(spoken[1], 'second', 'вторая фраза — та, что просили');
...
eq(spoken[0], 'new one', 'звучит именно новая фраза');

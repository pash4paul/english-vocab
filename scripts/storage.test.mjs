...
const deck = {
  ...
  levels: ['A1'],
  words: [
    { id: 'house:noun', en: 'house', ru: 'дом', pos: 'noun', level: 'A1', topic: 'Дом', tags: [] },
    { id: 'write:verb', en: 'write', ru: 'писать', pos: 'verb', level: 'A1', topic: 'Базовые глаголы', tags: [] },
    { id: 'big:adj', en: 'big', ru: 'большой', pos: 'adj', level: 'A1', topic: 'Прилагательные', tags: [] },
  ],
};
...
function sample() {
  ...
  for (const id of ['house:noun', 'write:verb', 'big:adj']) {
...
ok(parsed.слова.some((w) => w.слово === 'house'), 'слова видны словами, а не только идентификаторами');
